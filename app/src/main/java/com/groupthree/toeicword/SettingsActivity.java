...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupActionBar();
        Preference kmh = getPreferenceScreen().findPreference("khoa_man_hinh");
        ...
        Preference nt = getPreferenceScreen().findPreference("nhac_tu");
        nt.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                boolean bl = preference.getSharedPreferences().getBoolean("nhac_tu", false);
                if (bl) {
                    itNhacTu.putExtra("nhac_tu", true);
                    startService(itNhacTu);
                } else {
                    stopService(itNhacTu);
                    itNhacTu.putExtra("nhac_tu", false);
                }
                return true;
            }
        });
