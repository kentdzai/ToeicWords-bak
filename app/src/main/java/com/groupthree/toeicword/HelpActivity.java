...
public class HelpActivity extends AppCompatActivity {
    ...
    public ArrayList<ListHelp> getValues() {
        ...
        String[] values = {"Hỗ trợ học 600 từ vựng Toeic nhanh nhất và đơn giản nhất với ba chế độ học: học qua màn hình khóa, học qua các bài luyện tập và học qua chế độ nhắc từ."
                ...
                , "Để hỗ trợ học nhanh 600 từ, chúng tôi hỗ trợ năm phương thức luyện tập là: nghe lặp, lật từ, trắc nghiệm, luyện nghe và luyện nói. Để có thể thực hiện các bài tập này, người dùng phải vào mục 'Từ vựng theo chủ đề' sau đó tích vào các chủ để cần luyện tập và quay lại màn hình chính để 'Học từ đã đánh dấu'."
